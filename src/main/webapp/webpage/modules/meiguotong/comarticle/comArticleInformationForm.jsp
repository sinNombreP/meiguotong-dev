	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/meiguotong/comarticle/comArticle/information"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="comArticle" enctype="multipart/form-data" action="${ctx}/meiguotong/comarticle/comArticle/save1" method="post" class="form-horizontal">
		<form:hidden path="id"/>
