		...
		<table>	
			...
			<tr>
				...
				<tr>
					...
					<td class="width-35">
                 	<fmt:formatDate value="${orderCar.createDate}" pattern="yyyy-MM-dd HH:MM:dd:ss"/>
					</td>					
				</tr>
					<tr>
					...
					<td class="width-35">
         	        ${orderCar.contactsName}
					</td>					
				</tr>
					<tr>
					<td class="width-15 active"><label class="pull-right">联系电话:</label></td>
					<td class="width-35">
         	         ${orderCar.contactsMobile}
					</td>					
				</tr>
					<tr>
					...
					<td class="width-35">
         	     <fmt:formatDate value="${orderCar.beginDate}" pattern="yyyy-MM-dd HH:MM:dd:ss"/>
					</td>					
				</tr>
					<tr>
				...
				<tr>
					...
					<td class="width-35">
         	         <fmt:formatDate value="${orderCar.payDate}" pattern="yyyy-MM-dd HH:MM:dd:ss"/>
					</td>					
				</tr>
				<tr>
