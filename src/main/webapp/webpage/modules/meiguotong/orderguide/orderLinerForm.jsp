		...
		<table>	
			...
			<tr>
				...
				<tr>
					...
					<td class="width-35">
                 	<fmt:formatDate value="${orderLiner.createDate}" pattern="yyyy-MM-dd HH:MM:dd:ss"/>
					</td>					
				</tr>
					<tr>
				...
				<tr>
					...
					<td class="width-35">
         	         <fmt:formatDate value="${orderLiner.payDate}" pattern="yyyy-MM-dd HH:MM:dd:ss"/>
					</td>					
				</tr>
				<tr>
