		...
		$(document).ready(function() {
			$("#inputForm").validate({
				submitHandler: function(form){
					...
					if($("input[name='labelAttrid']").length==0){
						jp.error("标签属性不能为空！");
						return;
					}
					jp.loading();
			...
			$(".dv_pic_box_b").on("change",".input_file_style_b",function(e){ 
			 ...
			 var ue = UE.getEditor('reserveInfo');//获得编辑器
			    ...
			    var ue1 = UE.getEditor('recommend');//获得编辑器
...
<div class="row">
	...
	<div class="panel panel-primary">
		...
		<tr>
         ...
         <td id="bg3"><a class="white white3" onclick="chgtt(3);">评论</a></td>
		 ...
		 <hr style="color:#000">
			...
			<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:textarea path="priceInfor" htmlEscape="false" rows="4"    class="form-control"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">产品经理推荐：</label>
					<div class="col-sm-10">
						<textarea   id="recommend" name="recommend"  style="width: 100%;height:150px">${scenicSpot.recommend}</textarea>
					</div>
				</div>
				<div class="form-group">					
			...
			<div id="book3" class="title"  style="display:none;">
				<iframe id="frame_content" src="${ctx}/meiguotong/comcomment/comComment/goComment?type=7&typeId=${scenicSpot.id}" frameborder="0" height="500px"  width="100%"></iframe>
			</div>
			<c:if test="${not empty listTitle}">
