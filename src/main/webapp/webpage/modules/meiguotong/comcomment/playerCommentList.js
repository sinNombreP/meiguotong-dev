...
$(document).ready(function() {
	$('#comCommentTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/meiguotong/comcomment/comComment/playerCommentData",
  ...
  function view(id){
	  window.location = "${ctx}/meiguotong/comcomment/comComment/playerChildComment?typeId=" + id;
  }
</script>