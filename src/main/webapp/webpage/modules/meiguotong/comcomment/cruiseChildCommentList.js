...
$(document).ready(function() {
	$('#comCommentTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/meiguotong/comcomment/comComment/CruiseChildCommentDate",
		    ...
		    , {
                ...
                formatter:  function operateFormatter(value, row, index) {
    		        return [
    		        	'<a href="${ctx}/meiguotong/comcomment/comComment/CruiseChildComment?typeId=' + type.id +'" class="view btn  btn-info btn-xs" title="查看" ><li class="fa fa-search-plus"></li>展开</a>',    		     
