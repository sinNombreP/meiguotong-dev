...
$(document).ready(function() {
	$('#comCommentTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/meiguotong/comcomment/comComment/CruiseCommentDate",
		    ...
		    , {
                ...
                formatter:  function operateFormatter(value, row, index) {
    		        return [
    		        	<shiro:hasPermission name="meiguotong:comcomment:comComment:view"> 
						'<a id="view" class="view" onclick="view('+row.id+')"><i class="fa fa-eye btn btn-success btn-xs">展开</i> </a>',
					</shiro:hasPermission>
  ...
  function view(id){
	  window.location = "${ctx}/meiguotong/comcomment/comComment/CruiseChildComment?typeId=" + id;
  }
</script>