...
<head>
	...
	<%@include file="comNavigationHotCityList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">热门城市列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="comNavigation" class="form form-horizontal well clearfix">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="meiguotong:comnavigation:comNavigation:add">
...
<%-- 			<shiro:hasPermission name="meiguotong:comnavigation:comNavigation:edit">
	...
	<!-- 表格 -->
	<table id="comNavigationTable"   data-toolbar="#toolbar"></table>
