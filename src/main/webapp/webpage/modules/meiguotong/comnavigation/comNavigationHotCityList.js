...
$(document).ready(function() {
	$('#comNavigationTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/meiguotong/comnavigation/comNavigation/HotCityDate",
  ...
  function deleteAll(){
   ...
   function add(){
	  jp.openDialog('新增热门城市', "${ctx}/meiguotong/comnavigation/comNavigation/HotCityform",'800px', '500px', $('#comNavigationTable'));
  }
  function view(id){//没有权限时，不显示确定按钮
	   <shiro:hasPermission name="meiguotong:comnavigation:comNavigation:view">
	  	jp.openDialogView('查看热门城市', "${ctx}/meiguotong/comnavigation/comNavigation/HotCityform?id=" + id,'800px', '500px', $('#comNavigationTable'));
	   </shiro:hasPermission>
  }
	function edit(id){//没有权限时，不显示确定按钮
	   <shiro:hasPermission name="meiguotong:comnavigation:comNavigation:edit">
	  	jp.openDialog('编辑热门城市', "${ctx}/meiguotong/comnavigation/comNavigation/HotCityform?id=" + id,'800px', '500px', $('#comNavigationTable'));
	   </shiro:hasPermission>
  }
</script>