		  ...
		  //请求方法
               ...
               columns: [{
		        ...
		        ,formatter:function(value, row , index){
		        	return '<div style="float:left;"><a href="${ctx}/meiguotong/compush/comPush/form?id='+row.id+'">'+value+'</a></div><div style="float:right;">'+row.createDate+'</div>';
		        	/*return '<div style="float:left;"><a href="#">'+value+'</a></div><div style="float:right;">'+row.createDate+'</div>';*/
		         }
			}
