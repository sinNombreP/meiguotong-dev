		...
		<table class="table table-bordered">
			<tbody>
				<tr>
					...
					<td class="width-35"><c:if test="${comTag.fatherId==0}">一级</c:if>
						<c:if test="${comTag.fatherId!=0}">二级</c:if></td>
				</tr>
				<tr>
				...
				<c:if test="${comTag.fatherId!=0}">
					<tr>
						<td class="width-15 active"><label class="pull-right">标签标题:</label></td>
						<td class="width-35"><input type="text" 
							value="${comTag.fatherContent}" htmlEscape="false" readonly="true"
							class="form-control " /></td>
					</tr>
					<tr>
						<td class="width-15 active"><label class="pull-right">标签属性:</label></td>
						<td class="width-35"><input type="text" name="content"
							value="${comTag.content}" htmlEscape="false"
							class="form-control required" /></td>
					</tr>
