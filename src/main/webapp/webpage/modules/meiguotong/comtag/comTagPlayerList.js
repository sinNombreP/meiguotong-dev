...
$(document).ready(function() {
	$('#comTagTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/meiguotong/comtag/comTag/PlayerDate",
		    ...
		    , {
                ...
                formatter:  function operateFormatter(value, row, index) {
					...
					(row.status==2?'<a href="#" class="status" title="禁用"><i class="fa fa-edit btn btn-warning btn-xs">显示</i> </a>':
  ...
  function deleteAll(){
   ...
   function add(type){
	  jp.openDialog('新增各项管理', "${ctx}/meiguotong/comtag/comTag/PlayerForm?type="+type,'800px', '500px', $('#comTagTable'));
  }
  function edit(id){//没有权限时，不显示确定按钮
  	 
	   <shiro:hasPermission name="meiguotong:comtag:comTag:edit">
	  jp.openDialog('编辑各项管理', "${ctx}/meiguotong/comtag/comTag/PlayerForm?id=" + id,'800px', '500px', $('#comTagTable'));
	   </shiro:hasPermission>
  }
