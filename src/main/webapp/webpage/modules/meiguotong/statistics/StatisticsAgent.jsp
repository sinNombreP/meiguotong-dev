...
<script type="text/javascript">
    ...
    $(function () {
        jp.get("${ctx}/meiguotong/statistics/Statistics/agent?begin="+$("#begin").val(), function (option) {
            // 指定图表的配置项和数据
            // 使用刚指定的配置项和数据显示图表。
      ...
      //调用日期
    	...
    	$("#search").click("click", function() {// 绑定查询按扭
	    	...
	    	jp.post("${ctx}/meiguotong/statistics/Statistics/agent",params, function (option) {
	            // 指定图表的配置项和数据
	            // 使用刚指定的配置项和数据显示图表。
	            myChart.setOption(option);
	        })
