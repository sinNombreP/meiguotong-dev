		                ...
		                columns: [{
	                        ...
	                        events: {
	            		        'click .view': function (e, value, row, index) {
	            		        	jp.openDialogView('查看角色', '${ctx}/sys/role/form?id=' + row.id,'600px', '300px');
	            		        },
	            		        'click .edit': function (e, value, row, index) {
	            		        	jp.openDialog('编辑角色', '${ctx}/sys/role/form?id=' + row.id,'600px', '300px');
	            		        },
	            		        'click .del': function (e, value, row, index) {
	            		        	del(row.id);
	            		        },
	            		        'click .auth': function (e, value, row, index) {
	            		        	jp.openDialog('菜单权限', '${ctx}/sys/role/auth?id=' + row.id,'350px', '700px');
	            		        },
