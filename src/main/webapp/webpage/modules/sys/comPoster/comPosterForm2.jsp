...
<div class="row">
	...
	<div class="panel panel-primary">
		...
		<form:form id="inputForm" enctype="multipart/form-data" modelAttribute="comPoster" action="${ctx}/sys/comPoster/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<c:if test="${fns:hasPermission('sys:comPoster:edit') || isAdd}">
