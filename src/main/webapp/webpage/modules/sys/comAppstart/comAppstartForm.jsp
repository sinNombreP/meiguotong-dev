		     ...
		     var ue = UE.getEditor('content');//获得去机器
		        ...
		        UE.Editor.prototype.getActionUrl = function(action) {
		             if (action == 'uploadimage' || action == 'uploadscrawl' || action == 'uploadimage') {
		                return '${ctx}/sys/comAppstart/uploadIMG'; //远程图片上传controller
		            } else {
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/sys/comAppstart"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="comAppstart"  enctype="multipart/form-data" action="${ctx}/sys/comAppstart/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
				<div class="form-group">
					<label class="col-sm-2 control-label" style="position:relative; left: -77px; top: 2px;">标题：</label>
					<div class="col-sm-3"  style="position:relative; left: -77px; top: 2px;">
						<form:input path="title" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label" style="position:relative; left: -77px; top: 2px;">广告图：</label>
					<div class="col-sm-5"  style="position:relative; left: -77px; top: 2px;">
 					<img alt="暂无图片" id="idCardFrontImg" src="${comAppstart.img}" height="100px",width="100px"/>    
				...
				<div class="form-group">
					<label class="col-sm-2 control-label" style="position:relative; left: -77px; top: 2px;">启动显示时间：</label>
					<div class="col-sm-2" style="position:relative; left: -77px; top: 2px;">
						<form:input path="time" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
					...
					<form:select path="type"  class="form-control m-b">
						...
						<form:option value="1" label="富文本"/>
						<form:option value="2" label="链接"/>
				...
				<div class="form-group">
					<label class="col-sm-2 control-label" style="position:relative; left: -77px; top: 2px;">状态：</label>
					<div class="col-sm-2"  style="position:relative; left: -77px; top: 2px;">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label" style="position:relative; left: -77px; top: 2px;">商品：</label>
					<div class="col-sm-8" style="position:relative; left: -77px; top: 2px;">
						<textarea   id="content" name="content" rows="40" cols="80" style="width: 100%">${comAppstart.content }</textarea>
					</div>
				</div>
		<c:if test="${fns:hasPermission('sys:comAppstart:edit') || isAdd}">
