...
<div class="row">
	...
	<div class="panel panel-primary">
		...
		<form:form id="inputForm" enctype="multipart/form-data" modelAttribute="comArticleCategory" action="${ctx}/sys/comArticleCategory/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
