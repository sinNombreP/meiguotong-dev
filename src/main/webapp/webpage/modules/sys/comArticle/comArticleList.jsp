...
<body>
		...
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="comArticle" class="form form-horizontal well clearfix">
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="文章标题：">文章标题：</label>
				<form:input path="title" htmlEscape="false" maxlength="255"  class=" form-control"/>
			</div>
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="分类名称：">分类名称：</label>
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="位置类型 1 普通 2 置顶：">位置类型：</label>
					<form:select path="positiontype" class="form-control ">
							<form:option value="" label="--请选择以下--"/>
							<form:option value="1" label=" 普通"/>
							<form:option value="2" label="置顶"/>
						</form:select>
			</div>
		 <div class="col-xs-12 col-sm-6 col-md-4">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="sys:comArticle:add">
			...
			<shiro:hasPermission name="sys:comArticle:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/sys/comArticle/import" method="post" enctype="multipart/form-data"
