...
<head>
	...
	<%@include file="sorceLogList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">积分管理列表</h3>
	</div>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="sys:score:sorceLog:add">
				<a id="add" class="btn btn-primary" href="${ctx}/sys/score/sorceLog/form" title="积分管理"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			...
			<shiro:hasPermission name="sys:score:sorceLog:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/sys/score/sorceLog/import" method="post" enctype="multipart/form-data"
