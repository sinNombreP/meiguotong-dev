	...
	<div class="sidenav-outer">
		<div class="side-widgets">
			<div class="text-center" style="padding-top:10px;"> 
				<a  href="#"><img class="img-circle user-avatar"  src="<c:if test="${photo == null || photo==''}">${ctxStatic}/common/images/flat-avatar.png</c:if> <c:if test="${photo != null && photo!=''}">${photo}</c:if>" class="user-avatar" /></a>
				<li class="dropdown admin-dropdown" style="padding-top:10px;">
					<a href="#" class="dropdown-toggle"  data-toggle="dropdown" role="button" aria-expanded="false">
						<font color="white">${name}<b class="caret"></b></font>
					</a>
