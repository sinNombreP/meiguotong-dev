        ...
        calendar: function (opt) {
            ...
            calendarDate.container = '' +
                ...
                '<div class="ht-bottom" style="display:none;">'+
                    '<ul>'+
                            '<li><img src="../../images/fjian1.png" alt="" />或<img src="../../images/fjian2.png" alt="" /><p>单人一房</p><span class="text-orange" data-money="113">'+app.currencySign+''+opt.data[0].oneCost+'/人</span></li>'+
                            '<li><img src="../../images/fjian1.png" alt="" />或<img src="../../images/fjian2.png" alt="" /><img src="../../images/fjian2.png" alt="" /><p>双人一房</p><span class="text-orange" data-money="113">'+app.currencySign+''+opt.data[0].twoCost+'/人</span></li>'+
                            '<li><img src="../../images/fjian2.png" alt="" /><img src="../../images/fjian2.png" alt="" /><p>三人一房</p><span class="text-orange" data-money="113">'+app.currencySign+''+opt.data[0].threeCost+'/人</span></li>'+
                            '<li><img src="../../images/fjian2.png" alt="" /><img src="../../images/fjian2.png" alt="" /><p>四人一房</p><span class="text-orange" data-money="113">'+app.currencySign+''+opt.data[0].fourCost+'/人</span></li>'+
                            '<li><i style="display:inline-block;width:28px;height:31px;font-size:12px;border:2px solid #ccc;border-radius:50%;">配</i><p>配房</p><span class="text-orange" data-money="113">'+app.currencySign+''+opt.data[0].arrangeCost+'/人</span></li>'+
                    '</ul>'+
                '</div>';
