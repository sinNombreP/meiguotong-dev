...
//  const baseUrl = "http://47.105.70.4:8080/meiguotong/a/interface/";
const baseUrl = "http://localhost:8082/meiguotong/a/interface/";
...
//获取广告列表
const getAdvertListUrl = baseUrl + "module/getAdvertListUrl";
//获取租车供应商列表
