package com.jeeplus.common.huanxin.model;
...
import com.jeeplus.common.huanxin.tool._Global;
...
public class Authentic {
	...
	private void flush() {
		synchronized(Authentic.class){
			try{
				if(token.isExpire()){
					//token = new Token("YWMtgz11WPBREeeinxeUlafw9QAAAWHvwO9WFhhiCjwq5GNuJu4u6jlHND9SwY4",4733514*1000+System.currentTimeMillis());
