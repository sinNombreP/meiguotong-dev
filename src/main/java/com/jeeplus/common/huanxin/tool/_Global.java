package com.jeeplus.common.huanxin.tool;
public class _Global {
	public static int APP_PAGE_SIZE = 5;
	public static String APP_KEY = "1143180115115500#daishu";
	public static String APP_CLIENT_ID = "YXA6UnsIIBrOEeiXPTd49dQnMg";
	public static String APP_CLIENT_SECRET = "YXA6ugUaSDI4rchuiNzTLrwdXgBqV-Y";
	//TODO 以上参数需相应修改
