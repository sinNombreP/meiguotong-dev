package com.jeeplus.common.utils.number;
...
import com.jeeplus.common.utils.base.MoreValidate;
...
public class RandomUtil {
	...
	* @Description: 年月日时分秒+指定随机数
	* @author 彭善智
	* @date 2018年3月21日 下午3:11:27 
	* 
	*/
	public static String randomString(Integer num){
		...
		// 有可能出现5位数，前面加0补全
		if (sixString.length() == num - 1) {
			sixString = "0" + sixString;
		}
		sixString = DateUtils.getDate("yyyyMMdd") + DateUtils.getDate("HHmmss") + sixString;
		return sixString;
	}
}
