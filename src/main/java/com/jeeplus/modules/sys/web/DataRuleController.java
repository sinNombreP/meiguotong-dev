...
public class DataRuleController extends BaseController {
	...
	public AjaxJson save(DataRule dataRule, Model model, RedirectAttributes redirectAttributes) throws Exception{
	...
	public AjaxJson delete(DataRule dataRule, RedirectAttributes redirectAttributes) {
		AjaxJson j = new AjaxJson();
